        ...
        <div class="w-8/12 bg-white p-6 rounded-lg">
            ...
            <form action="{{ route('personnel.update', $personnel->id) }}" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" id="name" placeholder="Personnel Full Name" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('name') border-red-500 @enderror" value="{{ $personnel->name }}">
                    @error('name')
                ...
                <div class="mb-4">
                    ...
                    <select name="position" id="position" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('position') border-red-500 @enderror"  value="{{ $personnel->position }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="rate" id="rate"  placeholder="Enter daily rate" class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('rate') border-red-500 @enderror" value="{{ $personnel->rate }}">
                    @error('rate')
                        <div class="text-red-500 mt-2 text-sm">
                            {{ $message }}
                        </div>
                ...
                <div class="mb-4">
                    ...
                    <select type="text" name="status" id="status"  class="bg-gray-100 border-2 w-full p-4 rounded-lg @error('status') border-red-500 @enderror" value="{{ $personnel->status }}">
